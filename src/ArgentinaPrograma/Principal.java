...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Producto prod3 = new Producto("Agua mineral","Agua mineral enbotellada por 1 litro", 20.00, 2);
		...
		itemCarrito[] vector = carro.traerCarrito();
		for (int i = 0; i <3; i ++) {
			System.out.println(vector[i].getCantidad()+" ---  "+ vector[i].getPrecio()+"  ------  "+vector[i].getProductos());
		}
		
		System.out.println("PRECIO TOTAL: "+carro.getPrecioTotal());		
